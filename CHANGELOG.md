...
- **Display**: Public share pages now render the sanitized chat answer as Markdown-derived HTML, include source titles/summaries beside original URL links, and clean trailing URL punctuation/backticks so copied links do not 404, while keeping raw HTML inert.
