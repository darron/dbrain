...
- **Item enrichment mirror**: Added a versioned `item_enrichments` current-state table for item summaries, OCR, and X media transcripts, with migration backfill and dual-writes from existing compatibility columns.
