...
- **Status health**: `dbrain tsnet status` now reports active running/reachable health, probes web and MCP when the node is running, checks certificate health, and exposes machine-readable JSON fields for automation.
