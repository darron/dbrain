...
- **Changed**: Sources linked from feed entries now fetch the linked article URL through dbrain's HTTP reader with Markdown `Accept` negotiation before falling back to local feed text or the external summarize CLI fetch path.
