...
func (s *Store) deleteItemsBySourceType(ctx context.Context, sourceType string) (DeleteItemsResult, error) {
	return withAuthoritativeWriteTx(ctx, s, "delete-items-by-source-type", func(ctx context.Context, tx authoritativeWriteTx) (DeleteItemsResult, error) {
...
func (s *Store) deleteOrphanSources(ctx context.Context, sourceType string) (DeleteSourcesResult, error) {
	return withAuthoritativeWriteTx(ctx, s, "delete-orphan-sources", func(ctx context.Context, tx authoritativeWriteTx) (DeleteSourcesResult, error) {
		query := `
